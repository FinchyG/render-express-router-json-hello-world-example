...
function GreetingsController() {
    ...
    function getMorningGreeting() {
        ...
        $.ajax('http://localhost:3000/timed_greetings/morning', { type: 'GET', success: onSuccess });
    }
    ...
    function getAfternoonGreeting() {
        ...
        $.ajax('http://localhost:3000/timed_greetings/afternoon', { type: "GET", success: onSuccess },
        );
    }
    ...
    function getEveningGreeting() {
        ...
        $.ajax('http://localhost:3000/timed_greetings/evening', { type: "GET", success: onSuccess },
        );
    }
    ...
    function getNightGreeting() {
        ...
        $.ajax('http://localhost:3000/timed_greetings/night', { type: 'GET', success: onSuccess },
        );
    }
